function initengahan(){
    ...
    wallpaper.style="transform: scale(20);";
  }
  
  async function mulainama() {
    bodyblur.style="opacity:.7";
    wallpaper.style="transform: scale(10);";
  ...
  function bqhilang(){wallpaper.style="transform: scale(2);";bodyblur.style="opacity:.7";bq.style = "position:relative;transition:all .7s ease;";}
  ...
  new TypeIt("#kalimat", {
  strings: ["" + vketik2], startDelay: 20, speed: 50, cursor: true, deleteSpeed: 70, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  new TypeIt("#pesan3", {
  strings: ["" + vketik3], startDelay: 20, speed: 50, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan3.innerHTML=vketik3;setTimeout(otomatis,600);setTimeout(aktipesan4,1010);
  },}).go();
  }
  function aktipesan4(){
    wallpaper.style="transform: scale(1);";kalimat.innerHTML=pesan4.innerHTML;kalimat.style="transform:scale(1.2)";setTimeout(aktipesan5,1000);
  }
  ...
  afterComplete: function(){
    pesan8.innerHTML=vketik9;setTimeout(otomatis,2000);setTimeout(aktipesan10,1710);
  },}).go();
  }
